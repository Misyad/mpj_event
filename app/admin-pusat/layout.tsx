...
import { Calendar, ChevronRight, CreditCard, Database, History, KeyRound, LayoutDashboard, MapPinned, Menu, QrCode, ReceiptText, UserCheck, UserRound, Users2, UsersRound, WalletCards, X } from 'lucide-react'
...
const navItems = [
  ...
  { href: '/admin-pusat/users', label: 'Akun Pengguna', icon: UserRound, exact: false },

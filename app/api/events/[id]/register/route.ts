    ...
    return NextResponse.json(
      {
        ...
        paymentProvider: result.paymentCoreRequest?.gatewayProvider ?? result.paymentCoreRequest?.paymentMethod ?? null,
        payUrl: result.paymentCoreRequest?.checkoutUrl ?? null,
        paymentInfo: result.paymentCoreRequest?.paymentInfo ?? null,
        paymentId: result.paymentCoreRequest?.paymentId ?? result.participant.paymentId ?? null,

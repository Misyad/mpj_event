...
const navItems = [
  ...
  { href: '/admin/events', label: 'Master Event', icon: Calendar, exact: false },
  { href: '/admin/narasumber', label: 'Narasumber', icon: Users2, exact: false },
  { href: '/admin/peserta', label: 'Master Peserta', icon: UserCheck, exact: false },
  { href: '/admin/master-data', label: 'Master Data', icon: Database, exact: false },
